...
export default class World {
    ...
    */
    async getTerrain(room: string) {
        ...
        return TerrainMatrix.unserialize(serial as unknown as string);
    }
    ...
    */
    async stubWorld() {
        ...
        await this.reset();
        // Utility functions
        const addRoomObjects = (roomName: string, objects: any[]) =>
            Promise.all(objects.map(o => this.addRoomObject(roomName, o.type, o.x, o.y, o.attributes)));
        const addRoom = (roomName: string, terrain: any, roomObjects: any[]) =>
            Promise.all([
